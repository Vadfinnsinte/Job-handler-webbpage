      ...
      <div className="show-info no-overflow">
        ...
        {!changePassword ? (
          <>
            ...
            <label className="center">Are you currently employed?</label>
            <div className="margin-top-1 self-center">
              <label className="margin-r1">
                <input
                  type="radio"
                  name="employment"
                  value="true"
            ...
            <p className={`center error ${!haveError && "invisible"}`}>
              {error}
            </p>
